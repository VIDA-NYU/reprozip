...
with io.open('README.rst', encoding='utf-8') as fp:
    description = fp.read()
setup(name='reprounzip-singularity',
      version='1.0.16',
      packages=['reprounzip', 'reprounzip.unpackers'],
      entry_points={
          'reprounzip.unpackers': [
              'singularity = reprounzip.unpackers.singularity:setup']},
      namespace_packages=['reprounzip', 'reprounzip.unpackers'],
      install_requires=[
          'reprounzip>=1.0.10',
          'rpaths>=0.8'],
      description="Allows the ReproZip unpacker to use Singularity containers",
